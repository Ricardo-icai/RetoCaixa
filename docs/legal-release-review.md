...
Validación de conexión · 2026-09-23: clave configurada en el entorno local privado y reconocida por el servidor de desarrollo mediante recarga de configuración. La API local devolvió HTTP 200 y fuente Twelve Data para AAPL/NASDAQ en 1D, 1W, 1M y 1Y (78, 65, 22 y 252 puntos respectivamente). Esto comprueba la conexión e históricos de ese activo en esos periodos; no acredita cobertura de todos los activos, latencia garantizada ni derechos comerciales. Se mantienen los pendientes de cobertura y licencias descritos arriba. La clave no se registra en esta evidencia ni se incluye en Git.
