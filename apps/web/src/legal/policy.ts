...
export const legalVersions = { terms: '2026-09-16.2', privacy: '2026-09-16.3', risk: '2026-09-16.1' } as const;
export type LegalAcceptance = {
  versions: { terms: string; privacy: string; risk: string };
  acceptedAt: string;
  countryCode: string;
  ageCheck: { minimumAge: 18; method: 'declared_birth_date'; checkedOn: string };
};
...
export function validLegalSubmission(body: Record<string, unknown>): boolean {
  ...
  return body.acceptTerms === true && body.acknowledgePrivacy === true && body.acceptRisk === true
