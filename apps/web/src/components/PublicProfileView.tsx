  ...
  return <main className="mx-auto min-h-screen max-w-md bg-slate-950 px-5 pb-24 pt-6 text-slate-100">
    ...
    {data && <>
      <header className="mt-8 text-center">
        ...
        {data.profile.investmentTag && <span className="mt-3 inline-block rounded-full border border-emerald-500/30 bg-slate-900/60 px-3 py-1 text-xs text-emerald-300 backdrop-blur-md">{data.profile.investmentTag}</span>}
      </header>
