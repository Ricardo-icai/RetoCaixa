...
export function SocialNetwork() {
  ...
  return <div className="mt-6 space-y-7">
    ...
    {snapshot && <>
      <div className="flex flex-wrap gap-4 text-sm text-slate-300"><span>{snapshot.me.name}</span><button onClick={() => void showFollowers(snapshot.me)} className="text-emerald-200">{snapshot.me.followersCount} seguidores</button><span>{snapshot.me.followingCount} siguiendo</span></div>
