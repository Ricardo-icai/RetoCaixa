...
function publicProfile(viewer) {
  mutateCommunity(viewer, { operation: 'completeOnboarding', goals: ['Aprender a invertir'], visibility: 'PUBLIC', countryCode: 'ES', nationality: 'Española', acceptTerms: true, legalVersions, dateOfBirth: '1990-05-15', acknowledgePrivacy: true, acceptRisk: true });
